...
export default function ProjectDetail() {
  ...
  return (
    <div className="md:max-w-3xl lg:max-w-4xl mx-auto sm:py-10 sm:px-4">
      ...
      <div className="flex flex-col md:flex-row mt-4 md:h-88 lg:h-104 gap-2 max-w-2xl md:ml-5">
        <div className="mx-5 py-5 md:mx-0">
          <h1 className="text-3xl font-headings font-black tracking-tight mb-1">{project.title}</h1>
          ...
          <p className="mb-4">{project.description.short}</p>
          <div className="bg-grey rounded-xs mb-4">
            <h2 className="text-xl font-bold">Features</h2>
            <p>{project.description.features}</p>
          </div>
          <div className="mb-5">
            <p>
              To view more details about the project check out the repository and readme.md file on{" "}
              <span className="font-semibold">GitHub</span> or view the{" "}
        ...
        {/* <img
          src={project.images.mobile}
          alt={project.title}
          className="hidden md:flex object-contain rounded-xs flex-grow "
        /> */}
      </div>
    </div>
  );
